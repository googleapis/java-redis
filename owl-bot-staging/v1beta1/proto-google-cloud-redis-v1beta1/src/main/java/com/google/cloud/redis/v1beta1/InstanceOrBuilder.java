...
public interface InstanceOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.redis.v1beta1.TlsCertificate> 
   ...
   * <code>repeated .google.cloud.redis.v1beta1.TlsCertificate server_ca_certs = 25 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.redis.v1beta1.TlsCertificateOrBuilder getServerCaCertsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.redis.v1beta1.NodeInfo> 
      getNodesList();
  /**
   * <pre>
   * Output only. Info per node.
   ...
   * <code>repeated .google.cloud.redis.v1beta1.NodeInfo nodes = 32 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.redis.v1beta1.NodeInfoOrBuilder getNodesOrBuilder(
      int index);
